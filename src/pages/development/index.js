                        ...
                        <FlexList flow="column" justifyContent="center">
                            <div className="item">
                                <svg width="21" height="22" viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M15.729 19.6463V21" stroke="white" stroke-width="1.6" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M19.269 16.4432C19.269 18.0462 17.9568 19.3591 16.3531 19.3591H4.41592C2.81217 19.3591 1.5 18.0462 1.5 16.4432V15.8964C1.5 14.2919 2.81217 12.9805 4.41592 12.9805H16.3531C17.9568 12.9805 19.269 14.2919 19.269 15.8964V16.4432V16.4432Z" stroke="white" stroke-width="1.6" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M3.68695 12.8383L5.3738 8.19107H10.3841" stroke="white" stroke-width="1.6" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M17.082 12.8383L15.3951 8.19107H10.3841" stroke="white" stroke-width="1.6" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M4.69803 16.1698H5.6078" stroke="white" stroke-width="1.6" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M15.1604 16.1698H16.0702" stroke="white" stroke-width="1.6" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M5.0392 19.6463V21" stroke="white" stroke-width="1.6" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M1.63521 6.57673L11.3125 1L19.4589 7.01412" stroke="white" stroke-width="1.6" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                                <p>1 Vaga</p>
                            </div>
                            <div className="item">
