                    ...
                    <Column>
                        <div className="separator">
                            ...
                            <p className="white-color">
                                Rua Nossa Senhora do Rosário - 480
                                Sala 01 e 02 | Palhoça - SC
                                CEP 88138-800
                            </p>
                        </div>
                    </Column>
                        ...
                        <Flex className="social">
                            <FlexList flow="row">
                                ...
                                <li>
                                    <a>
                                        <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M20.0381 0H1.63813C1.19563 0 0.838135 0.3575 0.838135 0.8V19.2C0.838135 19.6425 1.19563 20 1.63813 20H20.0381C20.4806 20 20.8381 19.6425 20.8381 19.2V0.8C20.8381 0.3575 20.4806 0 20.0381 0ZM16.2206 7.2425C16.2281 7.36 16.2281 7.4825 16.2281 7.6025C16.2281 11.2725 13.4331 15.5 8.32563 15.5C6.75063 15.5 5.29063 15.0425 4.06063 14.255C4.28563 14.28 4.50064 14.29 4.73064 14.29C6.03064 14.29 7.22564 13.85 8.17813 13.105C6.95814 13.08 5.93313 12.28 5.58313 11.18C6.01063 11.2425 6.39563 11.2425 6.83563 11.13C6.20745 11.0024 5.64282 10.6612 5.23768 10.1645C4.83253 9.66771 4.61185 9.04602 4.61313 8.405V8.37C4.98063 8.5775 5.41314 8.705 5.86563 8.7225C5.48524 8.46899 5.17328 8.12553 4.95741 7.72257C4.74155 7.31962 4.62844 6.86963 4.62813 6.4125C4.62813 5.895 4.76314 5.4225 5.00564 5.0125C5.70289 5.87084 6.57296 6.57286 7.5593 7.07291C8.54563 7.57297 9.62615 7.85988 10.7306 7.915C10.3381 6.0275 11.7481 4.5 13.4431 4.5C14.2431 4.5 14.9631 4.835 15.4706 5.375C16.0981 5.2575 16.6981 5.0225 17.2331 4.7075C17.0256 5.35 16.5906 5.8925 16.0131 6.235C16.5731 6.175 17.1131 6.02 17.6131 5.8025C17.2356 6.3575 16.7631 6.85 16.2206 7.2425Z" fill="white" />
                                        </svg>
                                    </a>
                                </li>
                            </FlexList>
                    ...
                    <Column>
                        <div className="icon-right">
                            <svg width="43" height="42" viewBox="0 0 43 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M41.5 1H1.5V41H41.5V1Z" stroke="white" stroke-width="2" stroke-miterlimit="10" />
                                <path d="M6.29998 10.1111C6.29998 17.0889 6.29998 36.6 6.29998 36.6L21.1 21.8L6.21109 6.91113L6.29998 36.6L21.1 21.8L35.5 36.2V6.91113" stroke="white" stroke-width="2" stroke-miterlimit="10" />
                            </svg>
                        </div>
                    </Column>
                </Grid>
